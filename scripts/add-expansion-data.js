...
const dataDir = path.join(__dirname, '..', 'Assets', 'Resources', 'GameData');
...
const newCards = [
  // === 县令专属 (6张) ===
  {
    ...
    Choices: [
      {
        ChoiceText: "如期足额征收，不打折扣",
        Tooltip: "严格执行朝令，但民怨沸腾",
        ...
        RelationshipEffects: [
          { NpcId: "npc_governor", FavorDelta: 8, TrustDelta: 5 }
        ]
      },
      {
        ChoiceText: "私下挪用官库补足缺额",
        Tooltip: "暗度陈仓，风险极大",
        ...
        RelationshipEffects: [
          { NpcId: "npc_registrar", FavorDelta: 5, TrustDelta: -8 },
          { NpcId: "npc_censor", FavorDelta: -5, TrustDelta: -10 }
        ]
      },
      {
        ChoiceText: "据实上报，请求宽限",
        Tooltip: "实事求是但得罪上级",
        ...
        RelationshipEffects: [
          { NpcId: "npc_governor", FavorDelta: -10, TrustDelta: -5 }
        ]
      }
    ]
  },
  {
    ...
    Title: "胡商案",
    Description: "一队粟特胡商途经本县时与本地商户发生冲突，双方各执一词。胡商自称持有鸿胪寺通关文牒，要求按蕃商律令处理；本地商户则叫嚷着"非我族类"。驿站外已聚集不少看热闹的百姓。",
    Type: "Decision", Rarity: "Uncommon", Repeatable: false,
    MinTurn: 3, MaxTurn: 0, MinRank: "CountyMagistrate", MaxRank: "Prefect",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "依唐律秉公断案，一视同仁",
        Tooltip: "公正之举，赢得上级赏识",
        ...
        RelationshipEffects: [
          { NpcId: "npc_governor", FavorDelta: 5, TrustDelta: 8 }
        ]
      },
      {
        ChoiceText: "偏袒本地商户，驱逐胡商",
        Tooltip: "短期民心但有后患",
        RequiredAttribute: "Intellect", RequiredValue: 0,
        Modifiers: [{ Attribute: "Reputation", Value: 5 }, { Attribute: "Charisma", Value: -5 }],
        FollowUpCardId: "", SetFlags: ["hushang_expel"],
        RelationshipEffects: [
          { NpcId: "npc_gentry", FavorDelta: 10, TrustDelta: 5 },
          { NpcId: "npc_governor", FavorDelta: -8, TrustDelta: -5 }
        ]
      },
      {
        ChoiceText: "居中调停，各打五十大板",
        Tooltip: "和稀泥但平事",
  ...
  },
  {
    ...
    Choices: [
      {
        ChoiceText: "隆重操办，借钱也要面子",
        Tooltip: "大撒银子，民心大振",
        RequiredAttribute: "Intellect", RequiredValue: 0,
        Modifiers: [{ Attribute: "Reputation", Value: 10 }, { Attribute: "Charisma", Value: 5 }],
        FollowUpCardId: "", SetFlags: ["feast_grand"],
        RelationshipEffects: [
          { NpcId: "npc_gentry", FavorDelta: 8, TrustDelta: 3 },
          { NpcId: "npc_abbot", FavorDelta: 5, TrustDelta: 3 }
        ]
      },
      {
        ChoiceText: "从简操办，量入为出",
        Tooltip: "节俭务实",
        ...
        RelationshipEffects: [
          { NpcId: "npc_deputy", FavorDelta: 5, TrustDelta: 5 }
        ]
      },
      {
        ChoiceText: "借机宣讲新政，化宴为政",
        Tooltip: "高难度操作，借题发挥",
        ...
        RelationshipEffects: [
          { NpcId: "npc_governor", FavorDelta: 5, TrustDelta: 5 },
          { NpcId: "npc_gentry", FavorDelta: -5, TrustDelta: -3 }
        ]
      }
    ]
  },
    ...
    Choices: [
      {
        ...
        RelationshipEffects: [
          { NpcId: "npc_registrar", FavorDelta: -20, TrustDelta: -15 }
        ]
      },
      {
        ChoiceText: "暗中监视，收集证据",
        Tooltip: "稳扎稳打，后续有大戏",
      ...
      {
        ChoiceText: "知会县丞，让他去查",
        Tooltip: "撒手掌柜",
        RequiredAttribute: "Intellect", RequiredValue: 0,
        Modifiers: [],
        FollowUpCardId: "", SetFlags: ["counterfeit_delegate"],
        RelationshipEffects: [
          { NpcId: "npc_deputy", FavorDelta: 3, TrustDelta: 5 }
        ]
      }
    ]
  },
  {
    ...
    Choices: [
      {
        ChoiceText: "铁证如山，依律严办",
        Tooltip: "高风险高回报——失去理财能手但赢得清名",
        ...
        RelationshipEffects: [
          { NpcId: "npc_registrar", FavorDelta: -50, TrustDelta: -50 },
          { NpcId: "npc_gentry", FavorDelta: -20, TrustDelta: -15 },
          { NpcId: "npc_censor", FavorDelta: 15, TrustDelta: 15 },
          { NpcId: "npc_governor", FavorDelta: 5, TrustDelta: 10 }
        ]
      },
      {
        ChoiceText: "私下施压，逼他吐出赃款",
        Tooltip: "黑吃黑，暗中发财",
        ...
        RelationshipEffects: [
          { NpcId: "npc_registrar", FavorDelta: -10, TrustDelta: -30 }
        ]
      },
      {
        ChoiceText: "按下不表，留作日后筹码",
        Tooltip: "留一手，以备不时之需",
        RequiredAttribute: "Scheming", RequiredValue: 15,
        Modifiers: [{ Attribute: "Scheming", Value: 5 }],
        FollowUpCardId: "", SetFlags: ["registrar_leverage"],
        RelationshipEffects: [
          { NpcId: "npc_registrar", FavorDelta: 5, TrustDelta: -20 }
        ]
      }
    ]
  },
    ...
    Choices: [
      {
        ...
        RelationshipEffects: [
          { NpcId: "npc_gentry", FavorDelta: -30, TrustDelta: -20 },
          { NpcId: "npc_governor", FavorDelta: 10, TrustDelta: 8 },
          { NpcId: "npc_censor", FavorDelta: 8, TrustDelta: 10 }
        ]
      },
      {
        ChoiceText: "与王家私下协商，各退一步",
        Tooltip: "妥协但维稳",
        RequiredAttribute: "Charisma", RequiredValue: 12,
        ...
        RelationshipEffects: [
          { NpcId: "npc_gentry", FavorDelta: 10, TrustDelta: 5 },
          { NpcId: "npc_governor", FavorDelta: -3, TrustDelta: -3 }
        ]
      },
      {
        ChoiceText: "敷衍了事，按旧册抄录",
        Tooltip: "最安全也最无能",
        RequiredAttribute: "Intellect", RequiredValue: 0,
        ...
        RelationshipEffects: [
          { NpcId: "npc_gentry", FavorDelta: 5, TrustDelta: 3 },
          { NpcId: "npc_censor", FavorDelta: -10, TrustDelta: -15 }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    Title: "漕运改道",
    Description: "转运使衙门来文：因黄河泥沙淤积，漕运将改走新渠道，途经你管辖的渭北三县。若承接漕运中转，本州商贸将迎来黄金期；但修建转运码头耗资巨大，且漕船带来的流民和纠纷也会激增。",
    Type: "Decision", Rarity: "Rare", Repeatable: false,
    MinTurn: 7, MaxTurn: 0, MinRank: "Prefect", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "全力争取，倾州之力修建码头",
        Tooltip: "大手笔投资，搏一把",
  ...
  },
  {
    ...
    Title: "漕运风波",
    Description: "码头建成通航不到两月，一艘漕船在你的辖区内沉没，船上三千石官粮落入水底。转运使大怒，勒令你十日内打捞完毕并赔偿损失。与此同时，有人密报：沉船并非意外，而是有人故意凿穿船底……",
    Type: "Crisis", Rarity: "Rare", Repeatable: false,
  ...
  },
  {
    ...
    Choices: [
      {
        ChoiceText: "照令征发，不折不扣",
        Tooltip: "服从军令但失民心",
        RequiredAttribute: "Intellect", RequiredValue: 0,
        Modifiers: [{ Attribute: "Reputation", Value: -12 }, { Attribute: "Martial", Value: 5 }],
        FollowUpCardId: "", SetFlags: ["conscript_full"],
        RelationshipEffects: [
          { NpcId: "npc_general", FavorDelta: 12, TrustDelta: 8 }
        ]
      },
      {
        ChoiceText: "以老弱充数，暗中保护壮丁",
        Tooltip: "暗度陈仓",
        RequiredAttribute: "Scheming", RequiredValue: 15,
        Modifiers: [{ Attribute: "Scheming", Value: 8 }, { Attribute: "Reputation", Value: 5 }],
        FollowUpCardId: "", SetFlags: ["conscript_fake"],
        RelationshipEffects: [
          { NpcId: "npc_general", FavorDelta: -10, TrustDelta: -15 }
        ]
      },
      {
        ChoiceText: "上书陈情，请求减免名额",
        Tooltip: "据理力争",
        RequiredAttribute: "Charisma", RequiredValue: 15,
        Modifiers: [{ Attribute: "Charisma", Value: 5 }, { Attribute: "Intellect", Value: 3 }],
        FollowUpCardId: "", SetFlags: ["conscript_petition"],
        RelationshipEffects: [
          { NpcId: "npc_general", FavorDelta: -5, TrustDelta: -3 }
        ]
      }
    ]
  },
  {
    ...
    Title: "州试舞弊案",
    Description: "州试放榜后，落第士子集体到州府门前喊冤，控诉今年的解元乃是考官亲侄，试卷中竟有三道题与考前泄露的"秘题"完全一致。此事若处理不当，恐怕会惊动朝廷。",
    Type: "Decision", Rarity: "Rare", Repeatable: false,
    MinTurn: 8, MaxTurn: 0, MinRank: "Prefect", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "彻查科场，革除考官，重新开考",
        Tooltip: "大刀阔斧，正本清源",
        RequiredAttribute: "Intellect", RequiredValue: 15,
  ...
  },
  {
    ...
    Title: "盐铁之利",
    Description: "本州境内发现一处天然盐泉。按制，盐铁归朝廷专营，应即刻上报。但若暗中先行开采，收益极为可观——足以解决州府财政困难。幕僚分成两派，争论不休。",
    Type: "Opportunity", Rarity: "Uncommon", Repeatable: false,
    MinTurn: 7, MaxTurn: 0, MinRank: "Prefect", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "立即上报朝廷，请求设盐监",
        Tooltip: "光明正大",
        ...
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: 10, TrustDelta: 10 },
          { NpcId: "npc_governor", FavorDelta: 5, TrustDelta: 5 }
        ]
      },
      {
        ChoiceText: "先行开采三月，赚够再报",
        Tooltip: "先捞一把再说",
        RequiredAttribute: "Scheming", RequiredValue: 15,
        Modifiers: [{ Attribute: "Scheming", Value: 8 }],
  ...
  // === 侍郎专属 (6张) ===
  {
    ...
    Title: "朝堂论战",
    Description: "大朝会上，改革派首辅提出"两税法"改革——废除租庸调，改按田亩和资产征税。保守派群臣激烈反对，称此举动摇国本。天子目光扫过群臣，落在你身上："卿以为如何？"",
    Type: "Decision", Rarity: "Common", Repeatable: false,
    MinTurn: 10, MaxTurn: 0, MinRank: "ViceMinister", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "力挺两税法，陈述地方实情",
        Tooltip: "力挺改革，旗帜鲜明",
        ...
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: 15, TrustDelta: 10 },
          { NpcId: "npc_zhongshu_cui", FavorDelta: -15, TrustDelta: -10 }
        ]
      },
      {
        ChoiceText: "附和保守派，维护祖制",
        Tooltip: "保守但安全",
        RequiredAttribute: "Intellect", RequiredValue: 0,
        Modifiers: [{ Attribute: "Reputation", Value: -5 }, { Attribute: "Charisma", Value: 3 }],
        ...
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: -15, TrustDelta: -10 },
          { NpcId: "npc_zhongshu_cui", FavorDelta: 10, TrustDelta: 8 }
        ]
      },
      {
        ChoiceText: "折中发言，各取所长",
        Tooltip: "高难度的圆滑",
  ...
  },
  {
    ...
    Title: "宦官矫诏",
    Description: "深夜，你的心腹密报：内侍省的高力借传旨之机，私自篡改了一道关于边将任免的诏书，将自己的亲信安插到灵武节度使的位子上。这意味着宦官集团正在染指军权。你手中握有证据，但高力耳目遍布宫禁……",
    Type: "Crisis", Rarity: "Rare", Repeatable: false,
    MinTurn: 11, MaxTurn: 0, MinRank: "ViceMinister", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "联合御史台，公开弹劾",
        Tooltip: "正面对决，九死一生",
        RequiredAttribute: "Intellect", RequiredValue: 15,
        ...
        RelationshipEffects: [
          { NpcId: "npc_eunuch", FavorDelta: -50, TrustDelta: -50 },
          { NpcId: "npc_censor", FavorDelta: 20, TrustDelta: 20 }
        ]
      },
      {
        ChoiceText: "密奏天子，私下进言",
        Tooltip: "暗中行动",
        RequiredAttribute: "Scheming", RequiredValue: 20,
        Modifiers: [{ Attribute: "Scheming", Value: 10 }, { Attribute: "Health", Value: -8 }],
        FollowUpCardId: "", SetFlags: ["eunuch_secret_report"],
        RelationshipEffects: [
          { NpcId: "npc_eunuch", FavorDelta: -20, TrustDelta: -30 }
        ]
      },
      {
        ChoiceText: "隐忍不发，等待时机",
        Tooltip: "留得青山在",
        RequiredAttribute: "Intellect", RequiredValue: 0,
  ...
  },
  {
    ...
    Title: "宫禁之变",
    Description: "弹劾奏章呈上的当夜，高力先发制人——调动神策军封锁宫门，以"清君侧"为名软禁天子。你与御史台数名官员被困在中书省，外面甲士环伺。消息传来：高力正在逐一清洗参与弹劾的朝臣。生死就在今夜。",
    ...
    Choices: [
      {
        ...
        RelationshipEffects: [
          { NpcId: "npc_eunuch", FavorDelta: -50, TrustDelta: -50 },
          { NpcId: "npc_censor", FavorDelta: 25, TrustDelta: 25 }
        ]
      },
      {
        ChoiceText: "从密道出逃，联络外镇勤王",
        Tooltip: "三十六计走为上",
        RequiredAttribute: "Scheming", RequiredValue: 18,
      ...
      },
      {
        ...
        RelationshipEffects: [
          { NpcId: "npc_eunuch", FavorDelta: 15, TrustDelta: -10 },
          { NpcId: "npc_censor", FavorDelta: -30, TrustDelta: -30 }
        ]
      }
    ]
  },
  {
    ...
    Title: "吏部铨选",
    Description: "你奉命主持本年吏部铨选，需从三百名候选官员中选拔地方要员。你的恩师暗示你安排几个"自己人"，改革派首辅则送来一份"推荐名单"。而你案头还压着一份御史台的检举——名单中有三人涉嫌行贿买官。",
    Type: "Decision", Rarity: "Common", Repeatable: false,
    MinTurn: 10, MaxTurn: 0, MinRank: "ViceMinister", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "严格按考核选拔，不徇私情",
        Tooltip: "刚正不阿",
        RequiredAttribute: "Intellect", RequiredValue: 18,
      ...
      {
        ChoiceText: "卖人情给改革派，换取支持",
        Tooltip: "政治交易",
        RequiredAttribute: "Scheming", RequiredValue: 12,
        Modifiers: [{ Attribute: "Scheming", Value: 8 }, { Attribute: "Reputation", Value: -5 }],
        FollowUpCardId: "", SetFlags: ["select_political"],
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: -5, TrustDelta: -5 }
        ]
      }
    ]
  },
  {
    ...
    Title: "牛李党争",
    Description: "朝堂上"牛党"与"李党"之争已达白热化。牛党主张科举取士、重文轻武；李党则力推门荫入仕、强军备边。两党各有宰相撑腰，中间地带越来越窄。你的同年好友分属两派，都在拉你"站最后一班车"。",
    Type: "Decision", Rarity: "Epic", Repeatable: false,
    MinTurn: 11, MaxTurn: 0, MinRank: "ViceMinister", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "投身牛党，赌科举派得势",
        Tooltip: "押注改革派",
        RequiredAttribute: "Intellect", RequiredValue: 0,
        Modifiers: [{ Attribute: "Charisma", Value: 5 }, { Attribute: "Intellect", Value: 5 }],
        FollowUpCardId: "", SetFlags: ["join_niu"],
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: 20, TrustDelta: 15 },
          { NpcId: "npc_zhongshu_cui", FavorDelta: -20, TrustDelta: -15 }
        ]
      },
      {
        ChoiceText: "投身李党，赌世族派得势",
        Tooltip: "押注保守派",
        RequiredAttribute: "Intellect", RequiredValue: 0,
  ...
  },
  {
    ...
    Title: "经筵进讲",
    Description: "天子诏令你在经筵上进讲《贞观政要》。这是直达天听的绝佳机会——讲得好则圣眷日隆，讲砸了则贻笑朝堂。你需要在"歌功颂德"和"借古讽今"之间拿捏分寸。",
    Type: "Opportunity", Rarity: "Uncommon", Repeatable: false,
    MinTurn: 10, MaxTurn: 0, MinRank: "ViceMinister", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "借太宗纳谏之事，暗谏当今弊政",
        Tooltip: "以古讽今，勇气可嘉",
      ...
      },
      {
        ...
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: -10, TrustDelta: -10 },
          { NpcId: "npc_eunuch", FavorDelta: 8, TrustDelta: 5 }
        ]
      }
    ]
  },
  ...
  // === 高阶通用 (2张) ===
  {
    ...
    Title: "天灾人祸",
    Description: "辖区遭遇百年不遇的大旱，紧接着蝗灾铺天盖地。饿殍遍野，流民四起。更雪上加霜的是，朝廷此时正忙于边患，赈灾拨款遥遥无期。你必须在没有外援的情况下独自应对这场浩劫。",
    Type: "Crisis", Rarity: "Uncommon", Repeatable: false,
    MinTurn: 5, MaxTurn: 0, MinRank: "CountyMagistrate", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "开常平仓，同时组织以工代赈",
        Tooltip: "教科书级应对",
        RequiredAttribute: "Intellect", RequiredValue: 15,
        Modifiers: [{ Attribute: "Reputation", Value: 15 }, { Attribute: "Intellect", Value: 8 }],
  ...
  // === 历史事件卡 (4张) ===
  {
    ...
    Title: "安史之乱爆发",
    Description: "天宝十四载十一月，范阳节度使安禄山以"清君侧、诛杨国忠"为名起兵叛乱，十五万铁骑南下。消息传来时，朝野震惊——承平日久的大唐，竟无人料到叛军如此势如破竹。洛阳陷落、潼关失守的急报接踵而至，天子仓皇西逃。乱世降临，你将何去何从？",
    Type: "Crisis", Rarity: "Legendary", Repeatable: false,
    MinTurn: 15, MaxTurn: 0, MinRank: "Prefect", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "追随天子，护驾入蜀",
        Tooltip: "忠心耿耿",
        RequiredAttribute: "Intellect", RequiredValue: 0,
        ...
        RelationshipEffects: [
          { NpcId: "npc_fuma_zheng", FavorDelta: 20, TrustDelta: 15 }
        ]
      },
      {
        ChoiceText: "坚守辖地，组织抵抗",
        Tooltip: "力挽狂澜",
        ...
        RelationshipEffects: [
          { NpcId: "npc_general", FavorDelta: 25, TrustDelta: 20 }
        ]
      },
      {
        ChoiceText: "审时度势，暂降叛军",
        Tooltip: "苟活但声名扫地",
        RequiredAttribute: "Scheming", RequiredValue: 20,
        ...
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: -30, TrustDelta: -40 },
          { NpcId: "npc_general", FavorDelta: -30, TrustDelta: -40 }
        ]
      }
    ]
  },
  {
    ...
    Title: "科举改革",
    Description: "天子颁诏改革科举：废除"公荐"旧制，改由糊名阅卷，以断绝权贵操控科场之弊。此举得到寒门士子的热烈拥护，却遭到世族门阀的强烈抵制。作为朝中要员，你不可能置身事外。",
    Type: "Decision", Rarity: "Epic", Repeatable: false,
    MinTurn: 10, MaxTurn: 0, MinRank: "ViceMinister", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "全力推动改革，亲自监督施行",
        Tooltip: "站在历史正确一边",
        RequiredAttribute: "Intellect", RequiredValue: 18,
      ...
      {
        ChoiceText: "阳奉阴违，暗中留下操作空间",
        Tooltip: "两面三刀",
        RequiredAttribute: "Scheming", RequiredValue: 18,
        Modifiers: [{ Attribute: "Scheming", Value: 10 }],
        FollowUpCardId: "", SetFlags: ["keju_reform_fake"],
        RelationshipEffects: [
          { NpcId: "npc_zhongshu_cui", FavorDelta: 10, TrustDelta: 5 }
        ]
      },
      {
        ChoiceText: "上书建议渐进改革，折中推行",
        Tooltip: "温和路线",
        RequiredAttribute: "Intellect", RequiredValue: 15,
  ...
  },
  {
    ...
    Title: "藩镇割据",
    Description: "安史之乱平定后，朝廷为安抚降将，大量设置藩镇。如今河朔三镇已成事实上的独立王国。你所辖之州正处于朝廷直辖区与藩镇势力范围的交界地带。两边都在拉拢你，而你的选择将决定这片土地未来数十年的命运。",
    Type: "Crisis", Rarity: "Epic", Repeatable: false,
    MinTurn: 8, MaxTurn: 0, MinRank: "Prefect", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "坚定站在朝廷一边，拒绝藩镇拉拢",
        Tooltip: "忠于朝廷",
        RequiredAttribute: "Martial", RequiredValue: 12,
        ...
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: 15, TrustDelta: 15 },
          { NpcId: "npc_general", FavorDelta: -10, TrustDelta: -8 }
        ]
      },
      {
        ChoiceText: "暗中与藩镇勾连，两头下注",
        Tooltip: "骑墙派",
        RequiredAttribute: "Scheming", RequiredValue: 18,
        Modifiers: [{ Attribute: "Scheming", Value: 10 }, { Attribute: "Reputation", Value: -10 }],
        FollowUpCardId: "", SetFlags: ["fanzhen_double"],
        RelationshipEffects: [
          { NpcId: "npc_general", FavorDelta: 10, TrustDelta: 5 }
        ]
      },
      {
        ChoiceText: "效仿藩镇，壮大自己的地方势力",
        Tooltip: "割据一方",
        RequiredAttribute: "Martial", RequiredValue: 15,
        ...
        RelationshipEffects: [
          { NpcId: "npc_censor", FavorDelta: -25, TrustDelta: -30 },
          { NpcId: "npc_general", FavorDelta: 15, TrustDelta: 10 }
        ]
      }
    ]
  },
  {
    ...
    Title: "甘露之变",
    Description: "大和九年（835年），天子与宰相密谋诛杀宦官头目仇士良。计划是在禁中设伏，诱宦官前来后一举擒杀。然而消息走漏，仇士良反扑。你在事变发生时正在含元殿，殿外已传来兵刃相交之声和惨叫。宫门即将关闭。",
    Type: "Crisis", Rarity: "Legendary", Repeatable: false,
    MinTurn: 13, MaxTurn: 0, MinRank: "ViceMinister", MaxRank: "GrandCouncilor",
    RequiredFlags: [], ExcludedFlags: [], RequiresMetaUnlock: false, MetaUnlockId: "",
    Choices: [
      {
        ChoiceText: "冲出宫门，逃出长安",
        Tooltip: "保命要紧",
        RequiredAttribute: "Martial", RequiredValue: 15,
      ...
      },
      {
        ...
        RelationshipEffects: [
          { NpcId: "npc_fuma_zheng", FavorDelta: 30, TrustDelta: 25 }
        ]
      },
      {
        ChoiceText: "伪装效忠宦官，暗中保护同僚",
        Tooltip: "暗中周旋",
        RequiredAttribute: "Scheming", RequiredValue: 22,
        Modifiers: [{ Attribute: "Scheming", Value: 12 }, { Attribute: "Reputation", Value: -10 }],
        FollowUpCardId: "", SetFlags: ["ganlu_undercover"],
        RelationshipEffects: [
          { NpcId: "npc_shence_qiu", FavorDelta: 10, TrustDelta: -5 },
          { NpcId: "npc_censor", FavorDelta: 20, TrustDelta: 20 }
        ]
      }
    ]
...
const newNPCs = [
  // 刺史阶段 3个
  {
    ...
    DisplayName: "长史 裴行俭",
    Biography: "州长史，出身河东裴氏旁支，明经及第后在地方辗转二十余年。精通唐律，案牍之功无人能及，但性情极为执拗——凡事只讲律令，不通人情。曾一举扳倒违法的上任刺史，在州府中人人忌惮。",
    Faction: "Reformist",
    Rank: "Prefect",
  ...
  },
  {
    ...
    DisplayName: "团练使 韩令坤",
    Biography: "团练使，出身行伍，十六岁从军，在与吐蕃的边境战争中立下战功。武艺超群、治军有方，但完全不懂文官那套。与折冲都尉秦虎是旧交，有袍泽之情，也有军权之争。瞧不起科举出身的文官。",
    Faction: "Military",
    Rank: "Prefect",
  ...
  },
  {
    ...
    DisplayName: "转运判官 柳如烟",
    Biography: "转运判官，自称出身江南柳氏，精于财务，经她之手的每一笔账都滴水不漏。真实身份是宦官高力安插在地方的耳目，暗中为宦官集团截留漕运利润。但她有自己的野心，并非简单的走狗。",
    Faction: "Neutral",
    Rank: "Prefect",
  ...
  // 侍郎阶段 3个
  {
    ...
    DisplayName: "中书舍人 崔玄靖",
    Biography: "中书舍人，出身清河崔氏——"五姓七望"之首。才华出众，二十三岁中进士，被誉为"崔家百年来第一才子"。骨子里的傲慢——不把非世族出身的官员放在眼里。是"李党"的中坚力量，掌管诏令起草权，一字之差就能改变政令走向。",
  ...
  },
  {
    ...
    DisplayName: "神策军中尉 仇士良",
    Biography: "唐代宦官政治的终极代表。入宫四十年，侍奉过四位天子，亲手操纵过两次皇位更替。以神策军中尉身份掌控禁军。不识字，不懂经义，但对权力的嗅觉超过朝堂上所有文官。极端记仇，好感跌破-30永远无法回正。",
    Faction: "Eunuch",
    Rank: "ViceMinister",
  ...
  },
  {
    ...
    DisplayName: "驸马都尉 郑颢",
    Biography: "荥阳郑氏才子，状元及第后名满天下，被天子招为驸马。内心矛盾重重——有治世之才，却因驸马身份而处处受限。他是朝堂上最特殊的存在——既是天子至亲，又是最孤立的局外人。所有派系都对他保持距离。",
    Faction: "Neutral",
    Rank: "ViceMinister",
...
// 读取现有数据
const cardPath = path.join(dataDir, 'CardDatabase.json');
const npcPath = path.join(dataDir, 'NPCDatabase.json');

const cardDB = JSON.parse(fs.readFileSync(cardPath, 'utf8'));
const npcDB = JSON.parse(fs.readFileSync(npcPath, 'utf8'));

// 去重检查
const existingCardIds = new Set(cardDB.Cards.map(c => c.CardId));
const existingNpcIds = new Set(npcDB.NPCs.map(n => n.NpcId));

let cardsAdded = 0, npcsAdded = 0;
...
for (const card of newCards) {
  if (!existingCardIds.has(card.CardId)) {
    ...
    console.log(`跳过已存在的卡牌: ${card.CardId}`);
  }
}

for (const npc of newNPCs) {
  if (!existingNpcIds.has(npc.NpcId)) {
    npcDB.NPCs.push(npc);
    npcsAdded++;
  } else {
    console.log(`跳过已存在的NPC: ${npc.NpcId}`);
  }
}

// 写入
fs.writeFileSync(cardPath, JSON.stringify(cardDB, null, 2), 'utf8');
fs.writeFileSync(npcPath, JSON.stringify(npcDB, null, 2), 'utf8');

console.log(`\n✅ 数据合并完成！`);
console.log(`   卡牌：${cardDB.Cards.length} 张（新增 ${cardsAdded} 张）`);
console.log(`   NPC：${npcDB.NPCs.length} 个（新增 ${npcsAdded} 个）`);
